...
$plugins = array(
  ...
  'sfCacophonyPlugin'				=> 'https://github.com/HollerLondon/sfCacophonyPlugin.git/trunk'
);
...
{
  // Add files
  _exec('svn add symfony test/* apps/frontend/modules/* apps/frontend/config/error apps/frontend/config/unavailable.php config/* web/* web/.htaccess data/fixtures lib/form/* lib/model/doctrine/sfDoctrineGuardPlugin apps/frontend/templates/empty.php');
