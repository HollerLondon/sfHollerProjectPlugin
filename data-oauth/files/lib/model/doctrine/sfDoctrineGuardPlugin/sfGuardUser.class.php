...
class sfGuardUser extends PluginsfGuardUser
{
  ...
  {
    if (!$this->fb) $this->fb = sfFacebook::getInstance();
   ...
   * @return boolean
   */
  public function hasTokenFor($provider)
  {
    $token = $this->getTokenFor($provider);
  ...
  /**
   * Upgrade to longer life Facebook access token so that app created users can
